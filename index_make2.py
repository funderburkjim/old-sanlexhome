...
-->
  ...
  Each dictionary has several types of display (B L A M), as well as PDF scan and XML (in <a href="https://en.wikipedia.org/wiki/SLP1">SLP1</a>) files for download (D).
   ...
   &nbsp; &nbsp;
    ...
    -->
    <!--
    <a href="http://www.sanskrit-lexicon.uni-koeln.de/scans/awork/apidev/sample/list-0.2.html"> <img src="/images/new_item.png"> &nbsp;display</a>
    -->
    <!-- removed 12-21-2017
    <a href="http://www.sanskrit-lexicon.uni-koeln.de/scans/awork/apidev/sample/list-0.2.html">  <b>New Display</b> (Dec 2016)</a>
   &nbsp; &nbsp;
    -->
     <b>New Displays: </b> &nbsp;
    <a href="http://www.sanskrit-lexicon.uni-koeln.de/scans/awork/apidev/sample/list-0.2.html">(Dec 2016)</a>
   &nbsp; 
    <a href="http://www.sanskrit-lexicon.uni-koeln.de/scans/awork/apidev/simple-search/v1.0/list-0.2s.html">(Dec 2017)</a>
...
<hr style="width:89%; margin-left:0px;"/>
  ...
  <p>The digitizations of works marked with an asterisk (*) were funded by the DFG-NEH Project 2010-2013.</p>
     ...
     <ul>
      ...
      <li>
       <a href="http://www.sanskritlibrary.org">Peter Scharf</a> (The Sanskrit Library)
      </li>
      <li>
       Malcolm D. Hyman 
